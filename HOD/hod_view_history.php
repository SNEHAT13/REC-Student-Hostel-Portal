...
if ($username) {
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    if ($department == 'EEE') {
      $sql = "SELECT * FROM student_leave_request WHERE (department='EEE - A'|| department='EEE - B') AND (classincharge_status='Accepted' || classincharge_status='Not need') AND hostelwarden_status='Accepted' AND (hod_status='Accepted' || hod_status='Rejected')";
      $result = mysqli_query($conn, $sql);
    ...
    if ($department == 'IT') {
      $sql = "SELECT * FROM student_leave_request WHERE (department='IT - A'|| department='IT - B') AND (classincharge_status='Accepted' || classincharge_status='Not need') AND hostelwarden_status='Accepted' AND (hod_status='Accepted' || hod_status='Rejected')";
      $result = mysqli_query($conn, $sql);
  ...
  <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
     <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
      <title>HOD View Leave History</title>
    </head>
    <body>
