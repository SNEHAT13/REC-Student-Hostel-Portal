...
$sql = "SELECT * FROM hostelwarden WHERE username='$username'";
...
<head>
  ...
  <title>Hostelwarden Dashboard</title>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="hostelwarden_view_request.php?username=<?php echo $data_encrypted_url;?>" target="_blank">Leave Request</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="hostelwarden_view_history.php?username=<?php echo $data_encrypted_url;?>" target="_blank">Leave History</a>
        </li>
        <li class="nav-item">
