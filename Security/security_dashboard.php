  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="security_view_request.php?username=<?php echo $data_encrypted_url;?>" target="_blank">Verify Leave</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="security_view_history.php?username=<?php echo $data_encrypted_url;?>" target="_blank">Verified History</a>
        </li>
        <li class="nav-item">
