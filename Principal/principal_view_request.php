...
echo '<h1><center>Leave Request</center></h1>';
    $sql = "SELECT * FROM student_leave_request WHERE (classincharge_status='Accepted' || classincharge_status='Not Need') AND hostelwarden_status='Accepted' AND (hod_status='Accepted' || hod_status='Not Need') AND  principal_status='Pending'";
...
if (isset($_POST['accept'])) {
  ...
  $sql = "UPDATE student_leave_request SET principal_status='Accepted' WHERE id='$id'";
  $result = mysqli_query($conn, $sql);
...
elseif (isset($_POST['reject'])) {
  $id = mysqli_real_escape_string($conn, $_POST['id']);
  $sql = "UPDATE student_leave_request SET principal_status='Rejected' WHERE id='$id'";
  $result = mysqli_query($conn, $sql);
